...
Each Joomla extension requires a manifest file. It is used by Joomla to install files in the correct locations and perform other tasks on installation or removal.

Please refer to the [Manifest Files](jdocmanual?article=docus/install-update/installation-manifest) section of the Joomla! Programmers Documentation for more information.

The following code shows the manifest file for the **Contacts** component (com_contact) as an example:
